<%@ Page Language="C#" AutoEventWireup="true" CodeFile="goumaijilu_list2.aspx.cs" Inherits="goumaijilu_list2" %>
            ...
            <tbody>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
								...
								<asp:TemplateColumn HeaderText="是否支付"><ItemTemplate><a href='zhifu/default.aspx?id=<%#DataBinder.Eval(Container.DataItem, "goumaidanhao") %>&biao=goumaijilu&tz=ht'><%#DataBinder.Eval(Container.DataItem, "iszf") %></a></ItemTemplate><HeaderStyle Width="80px" /></asp:TemplateColumn>
