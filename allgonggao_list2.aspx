<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allgonggao_list2.aspx.cs" Inherits="allgonggao_list2" %>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="删除">
                                	<ItemTemplate>
                                    	<a href='delgg.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=allgonggao&npage=allgonggao_list2.aspx&lb=<%=lbtxt %>' onclick="return confirm('确定要删除？')">删除</a>
                               		</ItemTemplate>
								<HeaderStyle Width="50px" />
                                </asp:TemplateColumn>
