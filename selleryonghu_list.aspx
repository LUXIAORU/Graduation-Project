<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selleryonghu_list.aspx.cs" Inherits="yonghuzhuce_list" %>
            ...
            <tbody>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField=yonghuming HeaderText='用户名'></asp:BoundColumn><asp:BoundColumn DataField=youxiang HeaderText='邮箱'></asp:BoundColumn><asp:BoundColumn DataField=jiguan HeaderText='籍贯'></asp:BoundColumn>
                                ...
                                <asp:TemplateColumn HeaderText="商家审核">
                                <ItemTemplate>
                                    <a href='sh.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>&yuan2=<%#DataBinder.Eval(Container.DataItem, "issh2") %>&tablename=yonghuzhuce&seller=seller' onclick="return confirm('确定要审核？')"
                                       ><%#DataBinder.Eval(Container.DataItem, "issh2") %></a>
                                </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
